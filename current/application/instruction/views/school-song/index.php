...
<?php echo $this->partial('navBar.php', array('page' => 'schoolSong'))?>
...
<p>
    <audio src="<?php echo BASE_URL ?>template/media/SchoolSong.ogg" controls>
        <object type="application/x-java-applet" width="320" height="15">
            ...
            <p>若無法播放，請使用
                ...
                、
                <img src="/template/img/browserLogo/googleChrome.png" title="Google 瀏覽器" alt="Google 瀏覽器" /><a href="http://www.google.com/chrome">Google 瀏覽器</a>
                或
                <img src="/template/img/browserLogo/opera.png" alt="Opera" title="Opera" /><a href="http://www.opera.com/">Opera</a>
                瀏覽器，另外也可以安裝<a href="http://www.java.com/zh_TW/">Java</a>。
            </p>
        </object>
    </audio>
</p>
